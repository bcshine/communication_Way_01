...
const employeeTypes = {
    ...
    type3: {
        title: "2. 매사핑계형",
        description: "사장의 지시나 요청에 대해 항상 핑계를 대며 책임을 회피하는 태도를 보임",
        initialMessage: "사장님, 어제 요청하신 보고서를 아직 못했어요. 어제는 컴퓨터가 너무 느려서 작업이 안됐고, 오늘은 다른 팀원들이 자꾸 방해해서 집중을 못했어요. 그리고 자료도 제대로 준비가 안됐고, 제가 요즘 몸도 안좋아서... 정말 죄송합니다."
    },
    type2: {
        title: "3. 뒷담화 유포형",
...
function showGossipEducationalMessage() {
    ...
    const messageContent = `
        <h3><i class="fas fa-info-circle"></i> 뒷담화와 소문 유포의 부정적 영향</h3>
        ...
        <button id="close-educational-message">확인 <i class="fas fa-check"></i></button>
    `;
...
function showVictimEducationalMessage() {
    ...
    const messageContent = `
        <h3><i class="fas fa-info-circle"></i> 피해자 의식과 관련된 커뮤니케이션 조언</h3>
...
function showDisobedienceEducationalMessage() {
    ...
    const messageContent = `
        <h3><i class="fas fa-info-circle"></i> 지시 불이행과 관련된 커뮤니케이션 조언</h3>
